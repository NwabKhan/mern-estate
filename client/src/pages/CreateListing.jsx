...
const CreateListing = () => {
  const { currentUser } = useSelector((state) => state.user); //Getting the user, to send it as ref(to know which user has created this listing)
  ...
  const handleChange = (e) => {
    //As its a single value 'type' which can be rent or sale, so we are setting type here
